...
This project is compatible with [Docker Flow: Proxy](https://github.com/vfarcic/docker-flow-prox) and [Docker Flow: Swarm Listener](https://github.com/vfarcic/docker-flow-swarm-listener) from https://github.com/vfarcic/docker-flow-proxy.
